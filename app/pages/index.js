        ...
        <div className={styles.container}>
                ...
                {initialized ? (
                    <div className={styles.todoInput}>
                        ...
                        <div className={styles.inputContainer}>
                            <form onSubmit={(e)=> {
                                e.preventDefault();
                                let input = document.getElementById(styles.inputField).value;
                                addTodo(input)
                                document.getElementById(styles.inputField).value = '';
                            }}>
            ...
            <div className={styles.mainContainer}>
                <Loading loading={loading}>
                    <TodoSection title="Tasks" todos={incompleteTodos} action={markTodo} removeTodo={removeTodo}/>
